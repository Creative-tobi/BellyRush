...
const AdminOTP = () => {
  ...
  const handleOTPSubmit = async (e) => {
    ...
    setLoading(true);
    try {
      const res = await Api.post("/verifyotp", { email: adminEmail, OTP: otp });
        ...
        <div className="w-full max-w-md">
          <form
            ...
            <button
              type="submit"
              disabled={loading}
              className="w-full bg-green-400 text-white py-3 rounded-lg hover:bg-green-500 transition duration-300 font-medium disabled:opacity-70 disabled:cursor-not-allowed">
