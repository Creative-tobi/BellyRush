...
const CustomerLogin = () => {
    ...
    const handleLogin = async (e) => {
        ...
        try {
            ...
            if (res.data.Buyer?._id) localStorage.setItem("buyerId", res.data.buyer._id);
            if (res.data.Buyer?.email) localStorage.setItem("buyerEmail", res.data.buyer.email);
            if (res.data.Buyer?.OTP) localStorage.setItem("buyerOTP", res.data.buyer.OTP);
            ...
            <div>
                <form className="bg-white p-6 rounded-lg shadow-md" onSubmit={handleLogin}> 
                    ...
                    <p className="mt-4 text-center">
                        ...
                        <Link to="/customer/register" className="text-green-600 hover:underline">
                            Register here
                        </Link>
                    </p>
                </form>
